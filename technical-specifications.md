...
_This specification is authoritative for tournament play and bot development. Version 1.1 - Updated to reflect current game server implementation (1 move per turn, ghost territory, updated socket events, and other changes)._
